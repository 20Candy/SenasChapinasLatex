...
Después de programar las pantallas para \textit{Android}, se tuvo la oportunidad de presentar el proyecto en la \textit{Expo} de la UVG. Durante la exposición, tanto usuarios como expertos en diseño ofrecieron recomendaciones que fueron implementadas tanto a nivel de diseño como en el funcionamiento de la aplicación:
...
\begin{figure} [H]
    \centering
    \includegraphics[width=1\linewidth]{figuras/prototipo5.png}
