...
\begin{itemize}
    ...
    \item \textbf{Grabación de video}: El 88\% de los usuarios logró grabar un video sin dificultades. Algunos usuarios mayores no comprendieron inicialmente que debían mantener el botón presionado, mientras que los usuarios más jóvenes reconocieron el diseño del botón de grabación, similar a otras plataformas, y lo manejaron sin problemas.
    ...
    \item \textbf{Completar un reto diario}: El 92\% de los usuarios completó el reto diario sin problemas, señalando que el sistema de colores y el \textit{feedback} visual al seleccionar la respuesta correcta era efectivo. Se recomendó aumentar el tamaño del botón correcto, como se sugirió anteriormente, para mejorar la visibilidad.
\end{itemize}
